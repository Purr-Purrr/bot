...
async def contact(message: Message):
    await message.answer('Вот сюда напишем всякую фигню и тг ссылку, ну шоб все по красоте было')

@router.message(F.text == 'О нас')
async def about_us(message: Message):
    await message.answer('Вот сюда напишем еще больше всякой фигни')
